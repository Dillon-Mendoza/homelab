...
A hybrid n8n + bash workflow that monitors networked devices on a 15-minute schedule and delivers a Discord notification when a device becomes unreachable. Built and tested in the Mudd Labs homelab as a repeatable client delivery template under the MuddBuilt Fiverr gig.
...
docker run -d \
    ...
    -e WEBHOOK_URL=https://<TAILSCALE-IP-T1> \
